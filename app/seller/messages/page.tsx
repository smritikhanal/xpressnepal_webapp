    ...
    try {
      ...
      if (inboxData.success && sentData.success) {
        ...
        allMessages.forEach((msg) => {
          // Determine the other user (not the current seller)
          const otherUserId = msg.isSent 
            ? msg.receiverId?._id || msg.senderId._id
            : msg.senderId._id;
                ...
                conversations.map((conversation) => (
                  <button
                    ...
                    className={`w-full text-left p-4 hover:bg-gray-50 transition-colors ${
                      selectedConversation?.userId === conversation.userId ? 'bg-green-50' : ''
                ...
                <div className="p-4 border-t border-gray-200 bg-gray-50">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-6 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center"
                    >
