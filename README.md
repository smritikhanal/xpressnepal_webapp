...
- **Integration Tests**: Tests for component interactions and user flows

For detailed information about writing and organizing tests, see [TESTING.md](./TESTING.md).
